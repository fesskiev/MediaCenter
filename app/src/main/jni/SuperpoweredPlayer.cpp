...
void SuperpoweredExample::onSeek(int value) {
    playerA->seek(value * 0.01f);
}
...
extern "C" JNIEXPORT void Java_com_superpowered_crossexample_MainActivity_onSeek(
        JNIEnv *__unused javaEnvironment, jobject __unused obj, jint value) {
    example->onSeek(value);
}
