 ...
 */
public class MediaExoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         */
        void buildRenderers(MediaExoPlayer player);
    ...
    public MediaExoPlayer(RendererBuilder rendererBuilder) {
