...
final public class CueParser {
     ...
     *
     * @param inputStream An {@link InputStream} that produces a cue sheet. The stream will be closed
     *                    afterward.
     ...
     *
     * @param input   The input to check.
     * @param pattern {@link Pattern} to check for. If it contains a capturing group, then on a match,
     *                this group will be
    ...
    /**
     * Get the last {@link TrackData} element. If none exist, an empty one is created and a warning
     * added.
     *
     * @param input
     * @return The last {@link TrackData} element. If none exist, an empty one is created and a
     * warning added.
     */
    ...
    /**
     * Get the last {@link FileData} element. If none exist, an empty one is created and a warning
     * added.
     *
     * @param input
     * @return The last {@link FileData} element. If none exist, an empty one is created and a warning
     * added.
     */
