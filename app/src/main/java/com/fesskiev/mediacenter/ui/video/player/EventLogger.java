 ...
 */
public class EventLogger implements MediaExoPlayer.Listener, MediaExoPlayer.InfoListener,
        MediaExoPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[MediaExoPlayer.RENDERER_COUNT];
  }
